...
router.post('/add', function(req, res) {
  pool.connect(function(errorConnectingToDb, db, done) {
    if (errorConnectingToDb) {
      ...
      req.body.fname, req.body.lname, req.body.email, req.body.role, req.body.password, req.body.session_id,
      function(queryError, result) {
        done();
        if (queryError) {
          res.sendStatus(500);
...
router.put('/update', function(req, res) {
  ...
  if (errorConnectingToDb) {
    ...
    db.query('UPDATE "users" SET "fname"=$1, "lname"=$2, "email"=$3, "role"=$4, "password"=$5, "session_id"=$6 WHERE "id" = $7;',
    req.body.fname, req.body.lname, req.body.email, req.body.role, req.body.password, req.body.session_id,
      function(queryError, result) {
        done();
        if (queryError) {
