...
router.post('/forgotpw', function(req, res, next) {
  ...
  pool.connect(function(errConnectingToDb, db, done) {
    if (errConnectingToDb) {
      next(err);var express = require('express');
      var router = express.Router();
      var nodeMailer = require('nodemailer');
      var pg = require('pg');
      var Chance = require('chance');
                ...
                db.query('UPDATE "users" SET "chance_token" = ($1), "chance_expiration" = ($2) WHERE "email" = ($3);', [
                  ...
                  if (queryError) {
                    ...
                    var mailOptions = {
                      ...
                      to: email,
                      subject: 'AchieveMpls Password Reset',
                      text: 'Hi ' + user.fname + '. You have recently requested a password reset for your account with AchieveMpls. To reset your password, please click here: ' + 'http://achievempls.coach/#/createPassword/' + newPW.code + ' Thank you, and have a great day!',
                      html:'<p>Hi ' + user.fname + ',</p><br><p>You have recently requested a password reset for your account with AchieveMpls.</p><p>To reset your password, please click on the following link:</p><p>http://achievempls.coach/#/createPassword/' + newPW.code + '</p><br><p>Thank you, and have a great day!</p>'
                    };
      ...
      */
      function newUserEmail(mailerObject, code) {
        var mailOptions = {
          //also set the emial here before running th app
          from: '"Achieve Mpls" <gradcoaches@gmail.com>',
          to: mailerObject.email,
          subject: 'Welcome to the Grad Coach Experience App!',
          text: 'Hi ' + mailerObject.fname + '! Welcome to the Grad Coach Experience App!  To activate your account, please click here: ' + 'http://achievempls.coach/#/createPassword/' + code + ' Thank you!  Have a great day!',
          html: '<p>Hi ' + mailerObject.fname + '!</p><br><p>Welcome to the Grad Coach Experience App!</p><p>To activate your account, please click on the following link:</p><p>http://achievempls.coach/#/createPassword/' + code +'</p><br><p>Thank you!  Have a great day!</p>'
        };
          transporter.sendMail(mailOptions, function(error, info) {
